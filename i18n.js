...
const I18N_UI_FR = {
  ...
  hero_cta_wa: "Réserver 30 min",
  hero_cta_wa_vitrine: "Réserver 30 min · Vitrine",
  hero_cta_wa_landing: "Réserver 30 min · Landing",
  hero_cta_wa_mobile: "Réserver 30 min · Mobile",
  hero_cta_wa_ppt: "Réserver 30 min · PowerPoint",
  wa_suffix_vitrine: " Site vitrine.",
  wa_suffix_landing: " Landing page.",
  wa_suffix_app: " Application mobile.",
  wa_suffix_ppt: " Présentation PowerPoint.",
};
const I18N_EN = {
  ...
  hero_h1: "A support that speaks for itself.",
  hero_lead:
    "Independents and small businesses · site, landing, app, PowerPoint · quote within 48 h.",
  hero_landing_title: "Software &amp;<br />cybersecurity",
  hero_landing_lead: "Profile, journey, lifestyle.",
  hero_landing_aria: "Open the personal landing page",
  hero_together: "Let's work together",
  hero_cta_wa: "Book 30 min",
  hero_cta_wa_vitrine: "Book 30 min · Showcase",
  hero_cta_wa_landing: "Book 30 min · Landing",
  hero_cta_wa_mobile: "Book 30 min · Mobile",
  hero_cta_wa_ppt: "Book 30 min · PowerPoint",
  hero_cta_work: "See the work",
  hero_works: "Work",
  hero_chips: "Offer formats",
  hero_chip_vitrine: "Showcase",
  hero_chip_landing: "Landing",
  hero_chip_mobile: "Mobile",
  hero_chip_ppt: "PowerPoint",
  hero_stage_vitrine: "LK Studio · showcase",
  hero_stage_landing: "Landing page",
  hero_stage_mobile: "MultiTask · mobile",
  hero_stage_ppt: "SME excerpt · PowerPoint",
  wa_suffix_vitrine: " Showcase site.",
  wa_suffix_landing: " Landing page.",
  wa_suffix_app: " Mobile app.",
  wa_suffix_ppt: " PowerPoint presentation.",
  ...
  trav_cta: "Book the 30 minutes",
  trav_hint: "scroll to move through the project",
  trav_count_1: "step 1 of 4",
  trav_count_2: "step 2 of 4",
  trav_count_3: "step 3 of 4",
  trav_count_4: "step 4 of 4",
  trav_go_1: "Go to step 1: Brief",
  trav_go_2: "Go to step 2: Proposal",
  trav_go_3: "Go to step 3: Design & build",
  trav_go_4: "Go to step 4: Delivery",
  trav_obj: "Goal",
  trav_aud: "Audience",
  trav_const: "Constraint",
  trav_30: "30 min",
  trav_s1_note: "we frame all of this together",
  trav_scope: "Scope",
  trav_time: "Timeline",
  trav_quote: "Quote",
  trav_48: "within 48 h",
  trav_valid: "Approved",
  trav_s2_note: "before I write a line",
  trav_progress: "progress",
  trav_review: "tweak it?",
  trav_fixed: "fixed ✓",
  trav_live: "live",
  trav_ship: "Go-live",
  trav_hand: "Handoff",
  trav_point: "Walkthrough",
  trav_yours: "it's yours!",
  offer_h2: "Offer",
  offer_intro:
  ...
  work_h2: "Work",
  work_intro: "Tap a screenshot: the brief opens below, with the detail and the links.",
  work_tabs: "Projects",
  ...
  pricing_h2: "Offer and Quotes",
  pricing_intro: "Four formats, each on quote.",
  pricing_consult: "A free 30-minute consultation",
  pricing_trust: "2 openings this quarter",
  pricing_stamp: "openings<br>this quarter",
  card_note_vitrine: "your online showcase",
  card_note_landing: "one page, one goal",
  card_note_app: "in your pocket",
  card_note_ppt: "ready to pitch",
  cartes_hint: "scroll to see the rest",
  pricing_from: "From — on quote",
  pricing_quote: "Request a quote",
  pricing_note: "Quote within 48 h",
  quote_aria_vitrine: "Request a quote: Showcase site",
  quote_aria_landing: "Request a quote: Landing page",
  quote_aria_app: "Request a quote: Mobile app",
  quote_aria_ppt: "Request a quote: PowerPoint presentation",
  price_vitrine_p: "Several pages to present your work and build trust.",
  price_vitrine_1: "Home, offer, about and contact",
  price_vitrine_2: "A fast site that ranks well on Google",
  price_vitrine_3: "Contact form, go-live and handoff",
  price_landing_p: "A single page to convince: message, proof, call to action.",
  price_landing_1: "Structure, interface copy and mobile version",
  price_landing_2: "Form or button to WhatsApp / email",
  price_landing_3: "Review together, then go live",
  price_app_p: "A phone tool in C# / .NET, made for real use.",
  price_app_1: "Mobile flow: home, generate, profile",
  price_app_2: "PDF / Word export and rules that fit your work",
  price_app_3: "Review together and project handoff",
  price_ppt_p: "A deck ready to present: pitch, class or report.",
  price_ppt_1: "Structure problem → offer → proof → decision",
  price_ppt_2: "Editable PowerPoint file + PDF version",
  price_ppt_3: "Online excerpt so you can judge the level",
  see_excerpt: "View the excerpt",
  chrono_aria: "30-minute call",
  chrono_label: "minutes",
  contact_h2: "Book 30 minutes",
  contact_sub:
    '<strong class="contact-wa">WhatsApp</strong> for the slot, or a message here.<br />Reply within 24 h · quote within 48 h.',
  phone_label: "Phone",
  form_lead: "Prefer to write?",
  form_note: "Send the brief here — same timing, in French or English.",
  label_name: "Name",
